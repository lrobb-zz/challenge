...
//Yii::import('application.vendors.swift.*');
...
//        return mail($email, '=?UTF-8?B?' . base64_encode($subject) . '?=', $message, $headers);
        ...
        $transport = $swift->smtpTransport('ssl://smtp.gmail.com', 465, "ssl")

                ->setUsername('triokc.challenge@gmail.com')

                ->setPassword('runf@st3r');
        ...
        $message = $swift->newMessage($subject)
                ...
                ->setFrom(array('triokc.challenge@gmail.com' => 'TRI-OKC Challenge'))
