 ...
 *
 * The followings are the available columns in table 'workouts':
 * @property integer $id
...
class Workouts extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('user_id, sport, distance, description, date', 'required'),
            array('user_id', 'numerical', 'integerOnly' => true),
            array('distance', 'numerical'),
            array('sport', 'length', 'max' => 25),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, user_id, sport, distance, date, description', 'safe', 'on' => 'search'),
        );
    }
